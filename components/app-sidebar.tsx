...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: '/cruzeiros', label: 'Cruzeiros', icon: Ship, flag: 'cruiseRadar' },
  { href: '/oportunidades-mundiais', label: 'Oportunidades', icon: TrendingUp, flag: 'worldOpportunityEngine' },
  { href: '/onde-ir', label: 'Onde Ir', icon: Navigation, flag: 'inspireMe' },
  { href: '/viagens', label: 'Minhas Viagens', icon: Luggage, flag: 'tripBuilder' },
