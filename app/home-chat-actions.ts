...
// e-mail de terceiro). Primeira tentativa quebrou o chat real
// (SUPABASE_SERVICE_ROLE_KEY não estava configurada — revertido na hora).
// Reaplicado em 27/08 depois de configurar a chave na Vercel e confirmar
// ao vivo que createAdminClient() funciona (migration 0042 revoga o
// EXECUTE público de novo).
